...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
        ...
        <?php
         ...
         ?>
		<div class="header-image" style="background-image: url(<?php if (empty($background_image)){echo get_template_directory_uri() . '/images/bg.jpg';}else{echo $background_image;} ?>);"></div>
